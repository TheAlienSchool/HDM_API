...
if (!window.TrajectoryVisualizer) {
  window.TrajectoryVisualizer = class TrajectoryVisualizer {
...
var TrajectoryVisualizer = window.TrajectoryVisualizer;

// ═══════════════════════════════════════════════════════════════
// PREDICTIVE LOOKAHEAD TRAIL
// ═══════════════════════════════════════════════════════════════

if (!window.PredictiveTrail) {
  window.PredictiveTrail = class PredictiveTrail {
    constructor(scene, stateEngine, config = {}) {
      this.scene = scene;
      this.stateEngine = stateEngine;
...
var PredictiveTrail = window.PredictiveTrail;
